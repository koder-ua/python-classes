...
%-------------------------------------------------------------------------------
\begin{center} \includegraphics[scale=0.4]{images/python_ecosystem.eps} \end{center}
\newpage

%-------------------------------------------------------------------------------
\begin{center} Версии и реализации \end{center}
\begin{itemize}
    \item Две ветви 2.X(2.7.6) и 3.X(3.3.3) 3.4.0 запланирована на 23 февраля
    ...
    \item Jython, PyPy, IronPython, Stackless Python, Py4A, QPython  ....
...
\begin{itemize}
    \item Windows: 2.7.6 с http://www.python.org/download/ 
