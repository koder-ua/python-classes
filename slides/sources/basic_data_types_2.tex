...
%-------------------------------------------------------------------------------
\center{Переменные (идентификаторы)}
\begin{itemize}
...
%-------------------------------------------------------------------------------
\center{type \& id \& hash \& isinstance}
\begin{itemize}
	\item type(x) => тип x
